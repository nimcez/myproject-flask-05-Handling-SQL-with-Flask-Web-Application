...
app.config['MYSQL_DATABASE_HOST'] = 'databasenc.cnigw4ai021t.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'databasenc'
app.config['MYSQL_DATABASE_DB'] = 'databese'
